...
void UIManager::Init()
{
	...
	logo[0]->load( new LoaderParams( 375, 300, 200, 100, "Stage" ) );

	logo[1] = new MenuButton();
	logo[1]->load( new LoaderParams( 375, 400, 200, 100, "Count" ) );

	logo[2] = new MenuButton();
	logo[2]->load( new LoaderParams( 375, 500, 200, 100, "Block" ) );

	logo[3] = new MenuButton();
	logo[3]->load( new LoaderParams( 375, 600, 200, 100, "Score" ) );
